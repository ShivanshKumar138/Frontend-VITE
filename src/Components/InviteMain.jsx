...
import * as QRCode from 'qrcode.react'; // ✅ Import all as an object
...
<Grid item xs={12} sx={{ textAlign: 'center' }}>
  <QRCode value={invitationLink} />
    ...
    <Grid container spacing={2} sx={{
        ...
        marginBottom:"150px"}}>
     <Grid item xs={12}>
     <Button variant="contained" fullWidth onClick={handleDownload} style={{ backgroundColor: '#4782ff',color:"white", borderRadius: "20px" }}>
  Invitation Link
</Button>
</Grid>
      <Grid item xs={12}>
  <Button variant="outlined" fullWidth onClick={handleCopyLink} style={{color:'#4782ff',borderColor:"#4782ff", borderRadius: "20px"}}>
